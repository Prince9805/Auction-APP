-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'BIDDER', 'AUDIENCE');

-- CreateEnum
CREATE TYPE "RoomStatus" AS ENUM ('WAITING', 'LIVE', 'CLOSED');

-- CreateEnum
CREATE TYPE "AccessStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');

-- CreateEnum
CREATE TYPE "ItemStatus" AS ENUM ('QUEUED', 'ACTIVE', 'SOLD', 'UNSOLD');
